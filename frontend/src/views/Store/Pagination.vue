...
const generatePageNumbers = (currentPage: number, totalPage: number, maxVisiblePages: number) => {
  pages.value = []
    ...
    <div class="flex items-center gap-1 md:gap-2">
      ...
      >
        <span
          ...
          @click="store.turnPage(store.nowPage - 1, nonebotStore.selectedBot?.project_id ?? '')"
        >
          chevron_left
        </span>
      </button>
